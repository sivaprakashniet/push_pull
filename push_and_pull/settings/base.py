...
ROOT_URLCONF = 'push_and_pull.urls'
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'push_and_pull.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'push_and_pull.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[push_and_pull]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_push_and_pull"  # Make this unique to your project.
